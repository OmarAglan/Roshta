...
{
    Task<Result<Patient>> AddPatientResultAsync(Patient patient);
    Task<Result<Patient>> UpdatePatientResultAsync(Patient patient);
    Task<Result> DeletePatientResultAsync(int id);
